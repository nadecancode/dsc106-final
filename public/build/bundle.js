...
var app = (function () {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$8, 4, 2, 36);
    			add_location(br, file$8, 7, 2, 759);
    			attr_dev(p1, "class", "body-text");
    			add_location(p1, file$8, 8, 2, 768);
    			add_location(section, file$8, 3, 0, 23);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    const file$7 = "src\\Components\\TextAndMathEquations.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$7, 16, 0, 357);
    			html_tag.a = t3;
    			html_tag_1.a = t4;
    			html_tag_2.a = t5;
    			attr_dev(p, "class", "body-text");
    			add_location(p, file$7, 17, 0, 408);
    			attr_dev(button, "class", "svelte-wigwt4");
    			add_location(button, file$7, 31, 2, 944);
    			attr_dev(div, "class", "button-div svelte-wigwt4");
    			add_location(div, file$7, 30, 0, 916);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "src\\Components\\LineChart.svelte";
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 65, 8, 2153);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				if (each_blocks[i]) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$4, 50, 0, 1604);
    			attr_dev(p0, "class", "body-text");
    			add_location(p0, file$4, 51, 0, 1657);
    			attr_dev(div0, "class", "steps-container svelte-1tar3ok");
    			add_location(div0, file$4, 58, 4, 1902);
    			attr_dev(svg0, "id", "chart3");
    			attr_dev(svg0, "class", "svelte-1tar3ok");
    			add_location(svg0, file$4, 70, 8, 2282);
    			attr_dev(div1, "class", "chart-one svelte-1tar3ok");
    			add_location(div1, file$4, 69, 6, 2249);
    			attr_dev(svg1, "id", "chart4");
    			attr_dev(svg1, "class", "svelte-1tar3ok");
    			add_location(svg1, file$4, 73, 8, 2356);
    			attr_dev(div2, "class", "chart-two svelte-1tar3ok");
    			add_location(div2, file$4, 72, 6, 2323);
    			attr_dev(div3, "class", "charts-container svelte-1tar3ok");
    			add_location(div3, file$4, 68, 4, 2211);
    			attr_dev(div4, "class", "section-container svelte-1tar3ok");
    			add_location(div4, file$4, 57, 2, 1865);
    			add_location(br0, file$4, 78, 2, 2438);
    			add_location(br1, file$4, 78, 8, 2444);
    			attr_dev(p1, "class", "body-text");
    			add_location(p1, file$4, 79, 2, 2454);
    			add_location(section, file$4, 55, 0, 1823);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "body-header");
    			add_location(h1, file$3, 1, 2, 29);
    			attr_dev(p, "class", "body-text");
    			add_location(p, file$3, 2, 2, 77);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$2, 1, 2, 28);
    			add_location(br0, file$2, 4, 4, 171);
    			add_location(br1, file$2, 4, 10, 177);
    			attr_dev(p0, "class", "body-text");
    			add_location(p0, file$2, 2, 2, 85);
    			attr_dev(a0, "class", "on-end svelte-1jnlkqb");
    			attr_dev(a0, "href", "https://d3js.org/");
    			add_location(a0, file$2, 8, 6, 261);
    			add_location(span0, file$2, 9, 6, 321);
    			attr_dev(p1, "class", "resource-item svelte-1jnlkqb");
    			add_location(p1, file$2, 7, 4, 228);
    			attr_dev(a1, "class", "on-end svelte-1jnlkqb");
    			attr_dev(a1, "href", "https://layercake.graphics/");
    			add_location(a1, file$2, 12, 6, 416);
    			add_location(span1, file$2, 13, 6, 490);
    			attr_dev(p2, "class", "resource-item svelte-1jnlkqb");
    			add_location(p2, file$2, 11, 4, 383);
    			attr_dev(a2, "class", "on-end svelte-1jnlkqb");
    			attr_dev(a2, "href", "https://katex.org/");
    			add_location(a2, file$2, 16, 6, 568);
    			add_location(span2, file$2, 17, 6, 629);
    			attr_dev(p3, "class", "resource-item svelte-1jnlkqb");
    			add_location(p3, file$2, 15, 4, 535);
    			attr_dev(a3, "class", "on-end svelte-1jnlkqb");
    			attr_dev(a3, "href", "https://svelte.dev/");
    			add_location(a3, file$2, 20, 6, 724);
    			add_location(span3, file$2, 21, 6, 787);
    			attr_dev(p4, "class", "resource-item svelte-1jnlkqb");
    			add_location(p4, file$2, 19, 4, 691);
    			attr_dev(div, "class", "resource-list svelte-1jnlkqb");
    			add_location(div, file$2, 6, 2, 195);
    ...
    const file$1 = "src\\Components\\ScrollSide.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 57, 8, 2305);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				if (each_blocks[i]) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p1.textContent = "And that's the end of our scrolly.";
    			attr_dev(h2, "class", "body-header");
    			add_location(h2, file$1, 42, 0, 1758);
    			attr_dev(p0, "class", "body-text");
    			add_location(p0, file$1, 43, 0, 1809);
    			attr_dev(div0, "class", "steps-container svelte-xapixo");
    			add_location(div0, file$1, 50, 4, 2054);
    			attr_dev(svg0, "id", "chart1");
    			attr_dev(svg0, "class", "svelte-xapixo");
    			add_location(svg0, file$1, 62, 8, 2434);
    			attr_dev(div1, "class", "chart-one svelte-xapixo");
    			add_location(div1, file$1, 61, 6, 2401);
    			attr_dev(svg1, "id", "chart2");
    			attr_dev(svg1, "class", "svelte-xapixo");
    			add_location(svg1, file$1, 65, 8, 2508);
    			attr_dev(div2, "class", "chart-two svelte-xapixo");
    			add_location(div2, file$1, 64, 6, 2475);
    			attr_dev(div3, "class", "charts-container svelte-xapixo");
    			add_location(div3, file$1, 60, 4, 2363);
    			attr_dev(div4, "class", "section-container svelte-xapixo");
    			add_location(div4, file$1, 49, 2, 2017);
    			add_location(br0, file$1, 69, 2, 2567);
    			add_location(br1, file$1, 69, 8, 2573);
    			attr_dev(p1, "class", "body-text");
    			add_location(p1, file$1, 70, 2, 2583);
    			add_location(section, file$1, 47, 0, 1975);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
  ...
  `
    ...
    const file = "src\\Components\\Dataset.svelte";
